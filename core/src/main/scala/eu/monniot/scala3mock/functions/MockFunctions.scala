...
trait MockFunctions {
  ...
  def mockFunction[T1, T2, T3, T4, T5, T6, T7, R: Default](using ctx: MockContext) =
    new MockFunction7[T1, T2, T3, T4, T5, T6, T7, R](ctx, "MockFunction7")
  def mockFunction[T1, T2, T3, T4, T5, T6, T7, T8, R: Default](using ctx: MockContext) =
    new MockFunction8[T1, T2, T3, T4, T5, T6, T7, T8, R](ctx, "MockFunction8")
  def mockFunction[T1, T2, T3, T4, T5, T6, T7, T8, T9, R: Default](using ctx: MockContext) =
    new MockFunction9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R](ctx, "MockFunction9")
  def mockFunction[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R: Default](using ctx: MockContext) =
    new MockFunction10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R](ctx, "MockFunction10")
}
